...
export const NVIDIA_MODELS: ChatModelDescriptor[] = [
  ...
  },
  {
    ...
    enabled: true,
    badge: "Recommended",
    description: "Large Meta model with strong reasoning.",
  },
  {
    ...
    enabled: true,
    badge: "Helpful",
    description: "NVIDIA-tuned Llama for helpfulness.",
  },
  {
    ...
    enabled: true,
    badge: "Code",
    description: "Code-specialized Qwen model — best for programming tasks.",
  },
];
